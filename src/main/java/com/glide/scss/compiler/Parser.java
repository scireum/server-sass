...
import com.glide.scss.compiler.ast.Attribute;
...
import com.glide.scss.compiler.ast.MediaFilter;
import com.glide.scss.compiler.ast.Mixin;
import com.glide.scss.compiler.ast.MixinReference;
import com.glide.scss.compiler.ast.NamedParameter;
import com.glide.scss.compiler.ast.Number;
import com.glide.scss.compiler.ast.Operation;
import com.glide.scss.compiler.ast.Section;
import com.glide.scss.compiler.ast.Stylesheet;
import com.glide.scss.compiler.ast.Value;
import com.glide.scss.compiler.ast.ValueList;
import com.glide.scss.compiler.ast.Variable;
import com.glide.scss.compiler.ast.VariableReference;
...
public class Parser {
    ...
    private Expression parseAtom() {
        ...
        if (tokenizer.current().isSpecialIdentifier("#")) {
            return new CSSColor(tokenizer.consume().getSource());
        }
