 ...
 */
public class CSSColor implements Expression {
    ...
    public class HSL {
         ...
         */
        public double getL() {
            return Double.parseDouble(String.format("%.2f", l));
        }
        ...
        public CSSColor getColor() {
            return new CSSColor(h, s, l, CSSColor.this.a);
        }
    }
     ...
     */
    public CSSColor(String hexString) {
     ...
     */
    public CSSColor(int hue, double saturation, double lightness, double transparency) {
        this.a = transparency;
